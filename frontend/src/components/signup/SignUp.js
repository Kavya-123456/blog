...
//   //make HTTP POST req
//   if(obj.role==='user'){
//   let res=await axios.post('http://loaclhost:4000/user-api/register',obj)
// console.log(res)
...
//   return (
//     <div>
//       <p className="display-3 text-center text-info">Sign Up</p>
//       {
//         err.length!=0 && <p className="text-danger fs-4">{err}</p>
//       }
//       <form className="w-50 bg-light p-3 m-auto mt-5">
  ...
  async function onRegister(obj){
    ...
    if(obj.role==='author'){
      ...
      if(res.data.message==='Author created'){
        console.log("author registration success")
        //navigate to signin component
        navigate('/signin')
        setErr('')
      }else{
